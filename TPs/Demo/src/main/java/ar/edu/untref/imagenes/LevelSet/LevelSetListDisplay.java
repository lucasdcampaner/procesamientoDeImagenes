 ...
 */
public class LevelSetListDisplay {
    /**
     ...
     * 
     * @param background
     *            The image to be used as a background (will be copied)
     * @param showIntermediates
     *            If true show intermediate speed and smooth iterations, otherwise
     *            only show full iterations
     */
    public LevelSetListDisplay(ImageProcessor background, boolean showIntermediates) {
     ...
     * 
     * @param colourIn
     *            The colour of the inside boundary
     * @param colourOut
     *            The colour of the outside boundary
     */
     ...
     * 
     * @param lin
     *            Iterator to the list of inside points
     * @param lout
