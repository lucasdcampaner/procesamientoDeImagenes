...
public class SpeedFieldFactory {
    ...
    public enum SfMethod {
        ...
        CHAN_VESE("Region (Chan Vese)"), HYBRID("Local region (Hybrid)"), EDGE(
                "Edge (Not implemented) (Geodesic active contours)");
        ...
        private static final java.util.Map<String, SfMethod> stringToEnum = new java.util.HashMap<String, SfMethod>();
     ...
     * 
     * @param method
     *            The name of the speedfield algorithm
     * @param im
     *            The image to be segmented
     * @param init
     *            The initialisation
     * @param hsfp
     *            Parameters for the HyrbidSpeedField
     */
    static public SpeedField create(String method, ImageProcessor im, BinaryProcessor init) {
